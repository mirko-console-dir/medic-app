    ...
    <div class="d_flex_column detail" id="account">
        ...
        <form method="post" action="{{ route('dashboard.doctors.update', $user->slug) }}" enctype="multipart/form-data">
            ...
            <div class="form-group d_flex_column">
                ...
                <!-- address -->
                <label class="edit_label" for="lastname">Lastname</label>
                ...
                <!-- Register_number_doc -->
                <label class="edit_label" for="register_number_doc">Register Doctor Number</label>
                ...
                <!-- Description -->
                <label class="edit_label" for="body">Description</label>
                ...
                <!-- Address -->
                <label class="edit_label" for="address">Address</label>
                <input type="text" name="address" id="address" class="form-control" placeholder="Insert your address" value="{{$user->address}}">
                <br>

                <!-- ManyToMany Service -->
                <label class="edit_label" for="clinic_id">Clinics where you want to operate </label>
                ...
                <label class="edit_label" for="specialization_id">Specializations </label>
                ...
                <!-- CV -->
                <label class="edit_label" for="cv_img">Curriculum Vitae</label>
                <input type="file" name="cv_img" class="form-control-file">
                <small class="text-muted">Add your CV file</small>
                <br>

                <!-- Profile_img -->
                <label class="edit_label" for="profile_img">Profile Image</label>
                ...
                <label class="edit_label" for="prefix_id">Country prefix</label>
                ...
                <!-- Phone_number -->
                <label class="edit_label" for="phone_number">Phone Number</label>
